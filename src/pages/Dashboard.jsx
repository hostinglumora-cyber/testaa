            ...
            {listings.map((l) => (
              <div key={l.id} className="flex items-center gap-4 px-5 py-3 hover:bg-secondary/30 transition">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground">{l.category} · {l.departments?.join(", ") || "No tags"}</p>
                </div>
            ...
            {orders.map((o) => (
              <div key={o.id} className="px-5 py-3 flex items-center gap-3">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground">from {o.buyer_name}{o.roblox_username ? ` · @${o.roblox_username}` : ""}</p>
                </div>
