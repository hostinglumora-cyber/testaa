            ...
            <div className="mt-10 pt-8 border-t border-border">
              ...
              {user && !isOwner && (
                <div className="rounded-xl border border-border bg-card p-4 mb-5">
                  ...
                  <textarea value={reviewForm.comment} onChange={(e) => setReviewForm({ ...reviewForm, comment: e.target.value })} rows={2} placeholder="Leave a review…" className="w-full bg-secondary border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary/50 resize-none" />
          ...
          <aside className="lg:sticky lg:top-24 h-fit">
            <div className="rounded-xl border border-border bg-card p-6">
              ...
              <div className="space-y-2.5 text-sm text-muted-foreground mt-5 pt-5 border-t border-border">
                ...
                <Row label="Departments" value={listing.departments?.join(", ") || "—"} />
