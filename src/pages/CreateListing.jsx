          ...
          {step === 1 && (
            <div className="space-y-5">
              ...
              <div>
                ...
                <textarea value={form.description} onChange={(e) => update({ description: e.target.value })} rows={4} placeholder="Describe what's included…" className="w-full bg-secondary border border-border rounded-lg px-3.5 py-2.5 focus:outline-none focus:border-primary/50 resize-none" />
              </div>
              <div>
          ...
          {step === 2 && (
            <div>
              ...
              <label className="block border-2 border-dashed border-border hover:border-primary/50 rounded-2xl p-10 text-center cursor-pointer transition">
                ...
                <p className="text-foreground font-medium">{uploading ? "Uploading…" : "Click to upload"}</p>
          ...
          {step === 3 && (
            <div>
              ...
              <div className="flex gap-2 mb-4">
                <input value={codeInput} onChange={(e) => setCodeInput(e.target.value)} onKeyDown={(e) => e.key === "Enter" && (e.preventDefault(), addCode())} placeholder="Paste a code…" className="flex-1 bg-secondary border border-border rounded-lg px-3.5 py-2.5 focus:outline-none focus:border-primary/50" />
          ...
          {step === 4 && (
            <div>
              ...
              <div className="mt-6 rounded-xl bg-primary/5 border border-primary/20 p-4 flex items-center gap-3">
                ...
                <p className="text-sm text-muted-foreground">Your listing is protected. Buyers cannot scam you — codes are only released after payment confirmation.</p>
              </div>
            </div>
          )}
