      ...
      <header className="sticky top-0 z-40 backdrop-blur-xl bg-background/80 border-b border-border">
        <div className="max-w-6xl mx-auto px-5 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="relative w-64 hidden sm:block">
            ...
            <input value={q} onChange={(e) => setQ(e.target.value)} placeholder="Search docs…" className="w-full bg-secondary border border-border rounded-lg pl-9 pr-3 py-1.5 text-sm placeholder:text-muted-foreground/50 focus:outline-none focus:border-primary/50" />
          </div>
        </div>
      </header>
